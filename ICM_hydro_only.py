...
logfile ='ICM_%s_ICM_Radar_Rainfall_analysis.log' % time.strftime('%Y%m%d_%H%M', time.localtime())
hydro_logfile = 'ICM_%s_Hydro_Radar_Rainfall_analysis.log' % time.strftime('%Y%m%d_%H%M', time.localtime()) 
...
print ('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
print ('~~                                                                                 ~~')
print ('~~    Version Calib/Valid ICMv3 - 09/12/2019                                       ~~')
print ('~~ Updated for Python 3.0 by Eric White for early 2023 Master Plan cal/val runs    ~~')
print ('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
print ('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
print ('')
...
#test_hydro_veg###########################################################
#test_hydro_veg#print ' Configuring Morphology Model.'
#test_hydro_veg## change working directory to wetland morph folder
...
#test_hydro_veg##########################################################
#test_hydro_veg#print ' Configuring HSI Model.'
...
#test_hydro_veg#    EH_tmp_file = os.path.normpath(ecohydro_dir + '\\tmp_monthly_ave_500m.out')
...
#test_hydro_veg#    EH_ChlA_file = os.path.normpath(ecohydro_dir + '\\tkn_monthly_ave_500m.out')
