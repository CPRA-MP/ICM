...
if g1 == g0:
    png_path = '%s/MP2023_S%02d_G%03d_C000_U%02d_V00_SLA_O_%02d_%02d_X_%s.png' (png_fol,s,g,s,g1,u,yr1,yr0,spec)
else:
    png_path = '%s/MP2023_S%02d_G%03d_C000_U%02d_V00_SLA_O_%02d_%02d_X_%s_diff.png' (png_fol,s,g1,u,yr1,yr0,spec)

asc1_path = '%s/S%02d/G%03d/hsi/asc/MP2023_S%02d_G%03d_C000_U%02d_V00_SLA_O_%02d_%02d_X_%s.asc' (s,g1,u,yr1,yr1,spec)
...
if g1 == g0:
    if yr1 == yr0:
        ...
        asc0_path = '%s/S%02d/G%03d/hsi/asc/MP2023_S%02d_G%03d_C000_U%02d_V00_SLA_O_%02d_%02d_X_%s.asc' (s,g0,u,yr0,yr0,spec)
