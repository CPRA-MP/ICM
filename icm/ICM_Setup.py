...
def ICMVars():
    ...
    mc_links = []
    # Years (calendar year) to update each respective'composite' marsh flow links (type 11) for marsh creation projects 
    # This value should be the year after the project is implemented in the morphology model
    mc_links_years = []
    ...
    return  (hyd_switch_years, hyd_file_orig, hyd_file_new, hyd_file_bk, links_to_change, link_years, FWA_prj_input_dir_MC, FWA_prj_input_dir_RR, 
             FWA_prj_input_dir_BS, mc_elementIDs, mc_years, mc_eid_with_deep_fill, mc_depth_threshold_def, mc_depth_threshold_deep, mc_links, 
             mc_links_years, sp_projectIDs, sp_years, rr_projectIDs, rr_years, comps_to_change_elev, comp_elevs, comp_years,act_del_files, 
             act_del_years)
