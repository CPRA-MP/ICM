...
print('Comparing year %02d to year %02d for for S%02d G%03d:' % (yr1,yr0,s,g) )
...
############################################
print('   - calculating land change (binary file)')
...
#############################################################
print('   - converting binary file to ASCI raster')
...
#############################################################
print('   - converting ASCI raster to TIF')
